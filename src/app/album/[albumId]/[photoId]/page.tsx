        ...
        <div className="h-[100vh] md:flex md:flex-col md:items-center">
            ...
            <div className="flex flex-col items-center justify-center md:relative md:h-full">
                ...
                {photo.navigation.previousPhoto && (
                    <div className="fixed left-2 top-1/2 transform -translate-y-1/2 md:left-6">
                        <Link href={`/album/${albumId}/${photo.navigation.previousPhoto}`}>
                ...
                {photo.navigation.nextPhoto && (
                    <div className="fixed right-2 top-1/2 transform -translate-y-1/2 md:right-6">
                        <Link href={`/album/${albumId}/${photo.navigation.nextPhoto}`}>
